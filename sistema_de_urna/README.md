sistema simples de votação, com servidor baseado em Express, incluindo criptografia com uso do módulo 'bcrypt' e geração de tokens de sessão por meio do módulo 'crypto', com armazenamento por parte do cliente por meio do
