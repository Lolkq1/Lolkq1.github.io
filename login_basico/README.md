sistema de login com uso de Express, mysql2 para gerenciamento dos dados, crypto pra geração de tokens de sessão, armazenados em cookies http-only e same-site secure, e bcrypt para criptografia de senha. <br>
